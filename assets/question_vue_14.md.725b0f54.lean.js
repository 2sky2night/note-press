import{_ as n,o as a,c as l,O as p}from"./chunks/framework.d0279b97.js";const F=JSON.parse('{"title":"h 函数定义和使用插槽","description":"","frontmatter":{},"headers":[],"relativePath":"question/vue/14.md","filePath":"question/vue/14.md","lastUpdated":1742602172000}'),o={name:"question/vue/14.md"};function e(t,s,c,r,E,y){return a(),l("div",null,s[0]||(s[0]=[p(`<h1 id="h-函数定义和使用插槽" tabindex="-1">h 函数定义和使用插槽 <a class="header-anchor" href="#h-函数定义和使用插槽" aria-label="Permalink to &quot;h 函数定义和使用插槽&quot;">​</a></h1><p>​ 使用 h 函数用来创建渲染虚拟 DOM，可以封装成函数，可以通过 JS 中调用快速渲染出一个组件。可是 h 函数如何定义和使用插槽呢?</p><h2 id="_1-定义插槽" tabindex="-1">1.定义插槽 <a class="header-anchor" href="#_1-定义插槽" aria-label="Permalink to &quot;1.定义插槽&quot;">​</a></h2><p>使用<code>renderSlots</code>来定义插槽，其原理就是通过上下文中的 slots 对象获取某个具名插槽的 key 来渲染出该插槽的内容</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">components</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="color:#24292E;">  document.body.</span><span style="color:#6F42C1;">appendChild</span><span style="color:#24292E;">(mask);</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,20)]))}const u=n(o,[["render",e]]);export{F as __pageData,u as default};
