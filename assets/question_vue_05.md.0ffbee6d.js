import{_ as n,o as a,c as l,O as p}from"./chunks/framework.d0279b97.js";const F=JSON.parse('{"title":"模态框","description":"","frontmatter":{},"headers":[],"relativePath":"question/vue/05.md","filePath":"question/vue/05.md","lastUpdated":1742573763000}'),o={name:"question/vue/05.md"};function e(t,s,c,E,r,y){return a(),l("div",null,s[0]||(s[0]=[p(`<h1 id="模态框" tabindex="-1">模态框 <a class="header-anchor" href="#模态框" aria-label="Permalink to &quot;模态框&quot;">​</a></h1><p>记录了一次封装模态框的代码。</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">style</span><span style="color:#24292E;">&gt;</span></span></code></pre></div>`,3)]))}const C=n(o,[["render",e]]);export{F as __pageData,C as default};
