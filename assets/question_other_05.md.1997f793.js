import{_ as n,o as a,c as p,O as l}from"./chunks/framework.d0279b97.js";const u=JSON.parse('{"title":"antd与tailwindcss冲突","description":"","frontmatter":{"title":"antd与tailwindcss冲突"},"headers":[],"relativePath":"question/other/05.md","filePath":"question/other/05.md","lastUpdated":1742575653000}'),e={name:"question/other/05.md"};function t(o,s,c,i,r,d){return a(),p("div",null,s[0]||(s[0]=[l(`<p>在 react 项目开发时，常常会使用这两个库，这两个库在一起工作时，在默认情况下会导致样式冲突的问题。</p><p>为了解决此问题，我们需要在 tailwind.config.js 中进行如下配置：</p><div class="language-diff vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">diff</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">/** @type {import(&#39;tailwindcss&#39;).Config} */</span></span>
