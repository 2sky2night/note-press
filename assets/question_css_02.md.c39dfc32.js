import{_ as n,o as a,c as l,O as p}from"./chunks/framework.d0279b97.js";const F=JSON.parse('{"title":"骨架屏 CSS 动画","description":"","frontmatter":{},"headers":[],"relativePath":"question/css/02.md","filePath":"question/css/02.md","lastUpdated":1742602172000}'),o={name:"question/css/02.md"};function e(t,s,c,r,E,y){return a(),l("div",null,s[0]||(s[0]=[p(`<h1 id="骨架屏-css-动画" tabindex="-1">骨架屏 CSS 动画 <a class="header-anchor" href="#骨架屏-css-动画" aria-label="Permalink to &quot;骨架屏 CSS 动画&quot;">​</a></h1><p>​ 自己在编写骨架屏的动画效果时没啥想法，又经常需要，所以记录在这儿。</p><p>​ 其实主要思路就是：</p><ol><li>设置渐变颜色的背景</li><li>通过 css<code>background-size</code>将背景放大</li><li>通过 css 动画动态的设置<code>background-position</code>背景的位置</li></ol><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">style</span><span style="color:#24292E;">&gt;</span></span></code></pre></div>`,5)]))}const C=n(o,[["render",e]]);export{F as __pageData,C as default};
