import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.816b1713.js";const C=JSON.parse('{"title":"Vue 命令式组件实践","description":"","frontmatter":{},"headers":[],"relativePath":"question/vue/09.md","filePath":"question/vue/09.md","lastUpdated":1699188084000}'),p={name:"question/vue/09.md"},o=l(`<h1 id="vue-命令式组件实践" tabindex="-1">Vue 命令式组件实践 <a class="header-anchor" href="#vue-命令式组件实践" aria-label="Permalink to &quot;Vue 命令式组件实践&quot;">​</a></h1><p>​ 以往封装的命令式组件往往都是通过 h 和 render，临时渲染的组件，并且文件拆分成了几个（函数文件、组件文件、样式文件），非常零散。</p><p>​ 这一次可以通过 jsx+css-in-js（@styils/vue）实现一个文件即可完成命令式组件的封装 @styils/vue： <a href="https://styils.github.io/styils/" target="_blank" rel="noreferrer">https://styils.github.io/styils/</a></p><div class="language-tsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">tsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { Component, createApp } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&quot;vue&quot;</span><span style="color:#E1E4E8;">;</span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,4),e=[o];function t(c,r,E,y,i,u){return n(),a("div",null,e)}const d=s(p,[["render",t]]);export{C as __pageData,d as default};
