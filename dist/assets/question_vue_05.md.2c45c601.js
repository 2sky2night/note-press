import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.816b1713.js";const u=JSON.parse('{"title":"模态框","description":"","frontmatter":{},"headers":[],"relativePath":"question/vue/05.md","filePath":"question/vue/05.md","lastUpdated":1699188084000}'),p={name:"question/vue/05.md"},o=l(`<h1 id="模态框" tabindex="-1">模态框 <a class="header-anchor" href="#模态框" aria-label="Permalink to &quot;模态框&quot;">​</a></h1><p>记录了一次封装模态框的代码。</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
